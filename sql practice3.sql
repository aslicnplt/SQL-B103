/* Child tabloda one delete cascade komutu yazılmazsa 
1)Child tablo silinmeden parent tablo silinmeye calsıldıgında pgadmin error verir
yani child tablo silinmeden parent tablo silinemez
2)Child tablodaki veri silinmeden parent tablodaki veri silinmeye calısıldıgında pgadmin error verir
yani child tablodaki veri silinmeden parent tablodaki veri silinemez
CHİLD TABLODA ONE DELETE CASCADE KOMUTU YAZİLİRSA 
1=Child tablo silinmeden parent tablo silinebilir
Pgadmin error vermez
2)Child tablodaki veri silinmeden Parent tablodaki veri silinmeye calisildiğinda Pgadmin error vermez
...
--Soru5: Malzemeler tablosundaki 'Telefon' degerlerini 'Phone' olarak guncelle
