...
select * from child;
/*child daki veri silinmeden parenttaki veri silinemez
childdaki tablo silinmeden parenttaki silinemez*/
--SORU 1: child tablosuna ted_verginosu 101 olan veri girişi yapınız
insert into child values(101,2000,'Araba','Burak');
--Soru2: child tablosuna ted_vergino su 105 olan veri girisi yapiniz. 
--bu soru cozulemez cunku parent tabloda olmayan primary key ile child tabloya veri girişi yapılamaz
insert into child values(105,2009,'Motor','Hasim') --calısmadı
--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child values(null,2013,'asli','canpolat');
--istisna olarak child yabloya parentta null olmamasına ragmen null ted_vergino yazarak giris yapabildik
--soru 4: parent tablosundaki vergi_no 101 olan veriyi siliniz
--foreign key le child tablo parent a baglandığı için ,
-- child tablodaki veri silinmeden parent tablodaki veri silinemez
delete  from parent where vergi_no=101;--error verir cunku 
--childdaki veriyi silmeden parenttaki silinemez
...
drop table parent;
--one delete cascade sayesinde child tabloyu silmeden parent tabloyu silebilecegiz
...
select * from child2;
--one delete cascade sayesinde child tablo veya icindeki veriler silinmeden
--parent tablo veya icindeki veriler silinebilir.
--yalnız boyle olunca child tablodaki veriler de siliniyor

--SORU1: parent2 tablosundaki tüm verileri siliniz
delete from parent2;
select*from parent2;
--child tablodaki veriyi silmeden parent tablodaki veriyi silebildik
--one delete cascade sayesinde
--SORU2: parent2 tablosunu siliniz
drop table parent2 cascade;
--child tabloyu silmeden parent tabloyu sildigimiz icin
--sonunda cascade komutunu kullan burda
